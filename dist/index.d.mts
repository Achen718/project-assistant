import { P as PackageJson, T as Technology, A as ArchitecturalPattern, C as CodePattern, a as AnalyzerResult, b as ProjectContext } from './client-C65nPLRT.mjs';
export { g as AIAssistantClientOptions, c as AIChatComponent, j as AnalyzerProjectContext, e as ChatInput, i as ChatSession, o as CodingConvention, t as DomainArchitecturalPattern, r as DomainCodePattern, u as DomainCodingConvention, w as DomainStoredAnalysisResult, q as DomainTechnology, h as Message, d as MessageItem, M as MessageList, N as NextConfig, S as StoredProjectContext, p as TSConfig, v as UserPreferenceValue, U as UserPreferences, f as createAIAssistant, m as deleteProjectContext, k as getLatestProjectContext, n as getProjectContextById, l as getUserProjects, s as storeProjectContext } from './client-C65nPLRT.mjs';
...
declare function processChat(message: string, history?: Message[], appContext?: string, projectId?: string): Promise<_langchain_core_messages.MessageContent>;
declare function processChatStream(message: string, // This is potentially augmentedMessage from the API route
history?: Message[], appContext?: string, projectContextInput?: ProjectContext): Promise<Response | ai.StreamTextResult<ai.ToolSet, never>>;
/**
